...
export const seoConfigs = {
  ...
  ko: {
    home: {
      ...
      description: 'TOPS CRE의 크레스티드 게코를 만나보세요. 희귀하고 독점적인 게코 모프를 전문으로 하는 브리더입니다.',
      keywords: ['크레스티드 게코', '게코 브리더', '이국적 애완동물', '게코 모프', '게코', '게코 번식'],
      ogTitle: 'TOPS CRE - 크레스티드 게코 브리더',
      ogDescription: 'TOPS CRE의 크레스티드 게코를 만나보세요. 희귀하고 독점적인 게코 모프를 전문으로 합니다.',
      ogImage: ogImage,
      ogUrl: baseUrl,
      twitterCard: 'summary_large_image',
    ...
    about: {
      ...
      keywords: ['게코 관리', '게코 번식', '이국적 애완동물', '동물 복지', '번식'],
    ...
    signature: {
      ...
      description: 'TOPS CRE의 희귀하고 독점적인 크레스티드 게코 라인업을 탐색해보세요. 컬렉션에서 완벽한 게코 동반자를 찾으세요.',
